     ...
     <div class="row">
         <div class="col-lg-4 col-md-4 col-lg-oush-4 col-md-push-4">
             ...
             <div class="card-body">
                ...
                <?php echo form_open('index.php/main_controller/login_process'); ?>
                ...
                <br>
                <div class="form-group">
                    <input type="submit" name="u_login"  value="Login as Admin" class="btn btn-info btn-sm">
                    <a href="http://platforma.lo/index.php/main_controller/register" class="btn btn-warning btn-sm">Register</a>
                </div>
